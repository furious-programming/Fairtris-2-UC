...
const
  KEYBOARD_SCANCODE_KEY_MENU: array [TRIGGER_KEYBOARD_KEY_FIXED_FIRST .. TRIGGER_KEYBOARD_KEY_FIXED_LAST] of Integer = (
...
const
  THUMBNAIL_BUTTON_X: array [TRIGGER_DEVICE_FIRST .. TRIGGER_DEVICE_LAST] of Integer = (5, 5,  1, 12, 22, 29, 42, 49);
  THUMBNAIL_BUTTON_Y: array [TRIGGER_DEVICE_FIRST .. TRIGGER_DEVICE_LAST] of Integer = (4, 15, 8, 8,  14, 14, 13, 13);

  THUMBNAIL_BUTTON_WIDTH:  array [TRIGGER_DEVICE_FIRST .. TRIGGER_DEVICE_LAST] of Integer = (7, 7, 4, 4, 6, 6, 6, 6);
  THUMBNAIL_BUTTON_HEIGHT: array [TRIGGER_DEVICE_FIRST .. TRIGGER_DEVICE_LAST] of Integer = (4, 4, 7, 7, 4, 4, 6, 6);
