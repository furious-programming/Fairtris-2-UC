...
const
  MAPPING_DEFAULT_KEYBOARD: array [KEYBOARD_KEY_FIRST .. KEYBOARD_KEY_LAST] of Integer = (
  ...
  MAPPING_DEFAULT_CONTROLLER: array [CONTROLLER_BUTTON_FIRST .. CONTROLLER_BUTTON_LAST] of Integer = (
