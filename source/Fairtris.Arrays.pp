...
const
  ...
  ITEM_TEXT_OPTIONS_BOOST: array [BOOST_FIRST .. BOOST_LAST] of String = (
    ITEM_TEXT_OPTIONS_BOOST_ENABLED,
    ITEM_TEXT_OPTIONS_BOOST_DISABLED
  );
