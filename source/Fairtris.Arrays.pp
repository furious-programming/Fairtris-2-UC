...
const
  KEYBOARD_KEY_RESERVED: set of UInt8 = [
    ...
    KEYBOARD_SCANCODE_KEY_FIXED_VIDEO {$IFDEF MODE_DEBUG},
    SDL_SCANCODE_PAGEUP,
...
const
  GAME_TITLE_COLOR: array [0 .. 255] of Integer = (
    ...
    $004400, $0028D8, $8C1824, $FC78F4, $000000, $A8D8FC, $98F858, $5C3C18,
    $B474FC, $B0BCFC, $888000, $747474, $1000A8, $8C1824, $1000A8, $000000,
    $1000A8, $009400, $8C1824, $6074FC, $6074FC, $007088, $747474, $B474FC,
    $BCBCBC, $6074FC, $000000, $005000, $C4C4C4, $FCFCFC, $6074FC, $007088,
