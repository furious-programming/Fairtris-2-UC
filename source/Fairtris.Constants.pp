...
const
  ...
  ITEM_X_MODES_FREE_MARATHON  = 112;
  ITEM_X_MODES_FREE_SPEEDRUN  = 112;
  ITEM_X_MODES_MARATHON_QUALS = 112;
  ITEM_X_MODES_MARATHON_MATCH = 112;
  ITEM_X_MODES_SPEEDRUN_QUALS = 112;
  ITEM_X_MODES_SPEEDRUN_MATCH = 112;
  ITEM_X_MODES_BACK           = 112;

  ITEM_X_GAME_MODE_REGION     = 72;
  ITEM_X_GAME_MODE_GENERATOR  = 72;
  ITEM_X_GAME_MODE_LEVEL      = 72;
  ITEM_X_GAME_MODE_START      = 72;
  ITEM_X_GAME_MODE_BACK       = 72;
  ITEM_X_GAME_MODE_BEST_SCORE = 72;
  ITEM_X_GAME_MODE_PARAM      = 160;
  ...
  ITEM_X_TOP_OUT_RESULT_TOTAL_TIME_TITLE   = 80;
  ITEM_X_TOP_OUT_RESULT_QUALS_END_IN_TITLE = 80;

  ITEM_X_TOP_OUT_RESULT_TOTAL_SCORE   = 256;
  ITEM_X_TOP_OUT_RESULT_TOTAL_TIME    = 256;
