...
const
  ITEM_LOBBY_REGION    = 0;
  ITEM_LOBBY_GENERATOR = 1;
  ITEM_LOBBY_LEVEL     = 2;
  ITEM_LOBBY_START     = 3;
  ITEM_LOBBY_BACK      = 4;

  ITEM_LOBBY_FIRST = ITEM_LOBBY_REGION;
  ITEM_LOBBY_LAST  = ITEM_LOBBY_BACK;

  ITEM_LOBBY_COUNT = ITEM_LOBBY_LAST + 1;
...
const
  ...
  ITEM_X_LOBBY_REGION     = 72;
  ITEM_X_LOBBY_GENERATOR  = 72;
  ITEM_X_LOBBY_LEVEL      = 72;
  ITEM_X_LOBBY_START      = 72;
  ITEM_X_LOBBY_BACK       = 72;
  ITEM_X_LOBBY_BEST_SCORE = 72;
  ITEM_X_LOBBY_PARAM      = 160;
  ...
  ITEM_X_TOP_OUT_PLAY = 120;
  ITEM_X_TOP_OUT_BACK = 120;

  ITEM_X_TOP_OUT_RESULT_TOTAL_SCORE   = 256;
  ITEM_X_TOP_OUT_RESULT_TRANSITION    = 256;
  ITEM_X_TOP_OUT_RESULT_LINES_CLEARED = 256;
  ITEM_X_TOP_OUT_RESULT_LINES_BURNED  = 256;
  ITEM_X_TOP_OUT_RESULT_TETRIS_RATE   = 256;
  ITEM_X_TOP_OUT_RESULT_QUALS_END_IN  = 256;

  ITEM_X_OPTIONS_INPUT    = 80;
  ITEM_X_OPTIONS_SET_UP   = 80;
  ITEM_X_OPTIONS_BOOST    = 80;
  ITEM_X_OPTIONS_SIZE     = 80;
  ITEM_X_OPTIONS_SOUNDS   = 80;
  ITEM_X_OPTIONS_BACK     = 80;
  ITEM_X_OPTIONS_PARAM    = 184;

  ITEM_X_KEYBOARD_CHANGE  = 72;
  ITEM_X_KEYBOARD_RESTORE = 72;
  ITEM_X_KEYBOARD_SAVE    = 72;
  ITEM_X_KEYBOARD_CANCEL  = 72;

  ITEM_X_KEYBOARD_KEY_UP     = 160;
  ITEM_X_KEYBOARD_KEY_DOWN   = 160;
  ITEM_X_KEYBOARD_KEY_LEFT   = 160;
  ITEM_X_KEYBOARD_KEY_RIGHT  = 160;
  ITEM_X_KEYBOARD_KEY_SELECT = 160;
  ITEM_X_KEYBOARD_KEY_START  = 160;
  ITEM_X_KEYBOARD_KEY_B      = 160;
  ITEM_X_KEYBOARD_KEY_A      = 160;
  ITEM_X_KEYBOARD_KEY_BACK   = 160;

  ITEM_X_KEYBOARD_SCANCODE = 224;

  ITEM_X_CONTROLLER_CHANGE  = 72;
  ITEM_X_CONTROLLER_RESTORE = 72;
  ITEM_X_CONTROLLER_SAVE    = 72;
  ITEM_X_CONTROLLER_CANCEL  = 72;

  ITEM_X_CONTROLLER_BUTTON_UP     = 160;
  ITEM_X_CONTROLLER_BUTTON_DOWN   = 160;
  ITEM_X_CONTROLLER_BUTTON_LEFT   = 160;
  ITEM_X_CONTROLLER_BUTTON_RIGHT  = 160;
  ITEM_X_CONTROLLER_BUTTON_SELECT = 160;
  ITEM_X_CONTROLLER_BUTTON_START  = 160;
  ITEM_X_CONTROLLER_BUTTON_B      = 160;
  ITEM_X_CONTROLLER_BUTTON_A      = 160;
  ITEM_X_CONTROLLER_BUTTON_BACK   = 160;

  ITEM_X_CONTROLLER_SCANCODE = 224;
...
const
  ...
  ITEM_Y_LOBBY_REGION    = 56;
  ITEM_Y_LOBBY_GENERATOR = 68;
  ITEM_Y_LOBBY_LEVEL     = 80;
  ITEM_Y_LOBBY_START     = 100;
  ITEM_Y_LOBBY_BACK      = 112;
  ...
  ITEM_Y_OPTIONS_INPUT    = 64;
  ITEM_Y_OPTIONS_SET_UP   = 76;
  ITEM_Y_OPTIONS_BOOST    = 96;
  ITEM_Y_OPTIONS_SIZE     = 120;
...
const
  ...
  ITEM_TEXT_LOBBY_REGION_NTSC = 'NTSC';
  ITEM_TEXT_LOBBY_REGION_PAL  = 'PAL';

  ITEM_TEXT_LOBBY_GENERATOR_7_BAG    = '7-BAG';
  ITEM_TEXT_LOBBY_GENERATOR_MULTIBAG = 'MULTI-BAG';
  ITEM_TEXT_LOBBY_GENERATOR_CLASSIC  = 'CLASSIC';
  ITEM_TEXT_LOBBY_GENERATOR_BALANCED = 'BALANCED';
  ITEM_TEXT_LOBBY_GENERATOR_TGM      = 'TGM';
  ITEM_TEXT_LOBBY_GENERATOR_TGM3     = 'TGM TERROR';
  ITEM_TEXT_LOBBY_GENERATOR_UNFAIR   = 'UNFAIR';

  ITEM_TEXT_LOBBY_REGION_TITLE    = 'REGION';
  ITEM_TEXT_LOBBY_GENERATOR_TITLE = 'RNG TYPE';
  ITEM_TEXT_LOBBY_LEVEL           = 'LEVEL';
  ITEM_TEXT_LOBBY_START           = 'START';
  ITEM_TEXT_LOBBY_BACK            = 'BACK';
  ...
  ITEM_TEXT_OPTIONS_BOOST_TITLE  = 'SHIFT BOOST';
    ITEM_TEXT_OPTIONS_BOOST_ENABLED  = 'ENABLED';
    ITEM_TEXT_OPTIONS_BOOST_DISABLED = 'DISABLED';
...
const
  ...
  BOOST_FIRST   = BOOST_ENABLED;
  BOOST_LAST    = BOOST_DISABLED;

  BOOST_COUNT   = BOOST_LAST + 1;
  BOOST_DEFAULT = BOOST_ENABLED;
...
const
  ...
  SETTINGS_KEY_GENERAL_BOOST  = 'BOOST';
...
const
  ...
  SETTINGS_VALUE_GENERAL_BOOST  = BOOST_DEFAULT;
