...
const
  ...
  ITEM_TOP_OUT_RESULT_POINTS_PER_LINE = 1;
...
const
  ITEM_X_LOBBY_REGION           = 96;
  ITEM_X_LOBBY_GENERATOR        = 96;
  ITEM_X_LOBBY_LEVEL            = 96;
  ITEM_X_LOBBY_START            = 96;
  ITEM_X_LOBBY_BACK             = 96;
  ITEM_X_LOBBY_PARAM            = 184;

  ITEM_X_LOBBY_BEST_LINES       = 56;
  ITEM_X_LOBBY_BEST_LEVEL_BEGIN = 104;
  ITEM_X_LOBBY_BEST_LEVEL_DASH  = 120;
  ITEM_X_LOBBY_BEST_LEVEL_END   = 128;
  ITEM_X_LOBBY_BEST_TETRISES    = 168;
  ITEM_X_LOBBY_BEST_SCORE       = 216;
...
const
  ITEM_X_TOP_OUT_RESULT_TOTAL_SCORE     = 272;
  ITEM_X_TOP_OUT_RESULT_POINTS_PER_LINE = 272;
  ITEM_X_TOP_OUT_RESULT_LINES_CLEARED   = 272;
  ITEM_X_TOP_OUT_RESULT_LINES_BURNED    = 272;
  ITEM_X_TOP_OUT_RESULT_TETRIS_RATE     = 272;
  ITEM_X_TOP_OUT_RESULT_QUALS_END_IN    = 272;
...
const
  ...
  ITEM_Y_TOP_OUT_RESULT_POINTS_PER_LINE = 68;
