...
begin
  Result := (ScanCodes[TRIGGER_CONTROLLER_BUTTON_UP]    <> CONTROLLER_SCANCODE_BUTTON_NOT_MAPPED) and
            (ScanCodes[TRIGGER_CONTROLLER_BUTTON_DOWN]  <> CONTROLLER_SCANCODE_BUTTON_NOT_MAPPED) and
            (ScanCodes[TRIGGER_CONTROLLER_BUTTON_LEFT]  <> CONTROLLER_SCANCODE_BUTTON_NOT_MAPPED) and
